...
$sqlActiv = "SELECT u.user_id, u.f_name, u.l_name, b.type FROM user u, blood b WHERE  (u.activated='1' AND u.type='2') AND (u.blood_id = b.blood_id)";

$sqlNotActiv = "SELECT u.user_id, u.f_name, u.l_name, b.type FROM user u, blood b WHERE (u.activated='0' AND u.type='2') AND u.blood_id = b.blood_id";
$noOfActiv = "SELECT COUNT(user_id) FROM user WHERE activated='1' AND type='1'";
$noOfNotActiv = "SELECT COUNT(user_id) FROM user WHERE activated='0' AND type='2'";
